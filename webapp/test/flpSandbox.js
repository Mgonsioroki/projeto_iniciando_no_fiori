		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#consultaproduto-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"consultaproduto-display": {
								"semanticObject": "consultaproduto",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=consultaproduto",
									"url": sap.ui.require.toUrl("consultaproduto")
								}
							}
						}
					}
